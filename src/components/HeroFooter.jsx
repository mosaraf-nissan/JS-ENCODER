        ...
        <div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5 xl:gap-10 text-xl font-bold text-white">
            <div className="flex flex-col justify-center items-center">
              <div className="rounded-full border-2 p-3 dark:border-cyan-200">
                <GiWallet className="text-7xl" />
              </div>
            ...
            <div className="flex flex-col justify-center items-center">
              <div className="rounded-full border-2 p-3 dark:border-cyan-200">
                <BsDatabaseFillLock className="text-7xl" />
              </div>
              <span>Secure & Reliable</span>
            </div>
            <div className="flex flex-col justify-center items-center">
              <div className="rounded-full border-2 p-3 dark:border-cyan-200">
                <GiScales className="text-7xl" />
              </div>
