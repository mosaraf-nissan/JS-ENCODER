...
const HeroFooter = () => {
  return (
    <div className="bg-gradient-to-tl dark:from-slate-800 dark:via-slate-800 dark:to-[#131C2F] pb-10">
      <div className="bg-gradient-to-r from-[#004AAD] via-[#2f74a8] to-[#004AAD] dark:backdrop-blur-lg dark:from-white/5 dark:shadow-lg dark:shadow-white/10 max-w-[1280px] mx-auto p-3">
        <div>
