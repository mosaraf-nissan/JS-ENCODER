      ...
      <footer className="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto bg-slate-900 text-wite rounded-md dark:bg-slate-800 dark:border dark:border-gray-600">
        ...
        <div className="flex justify-between md:mx-10 gap-2 md:gap-6 mb-10">
          <div className="col-span-full hidden lg:col-span-1 lg:block">
            ...
            <p className="mt-3 text-xs sm:text-sm text-gray-400 dark:text-gray-400">
          ...
          <div>
            <h4 className="text-xs font-semibold text-gray-100 uppercase dark:text-gray-100">
              Services
            </h4>
            ...
            <div className="flex items-center gap-x-3">
              ...
              <div className="hs-dropdown relative inline-flex [--placement:top-left]">
                ...
                >
                  ...
                  English (US)
                  <svg
                    className="hs-dropdown-open:rotate-180 flex-shrink-0 w-4 h-4 text-gray-400"
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
